...
const configuration: ChatCompletionMessageParam[] = [
    ...
    {role: 'system', content: 'Seré claro y sobretodo muy breve con mis respuestas, comprendiendo que el usuario no maneja ni entiende a la perfección términos legales'},
    {role: 'system', content: 'Cuando la consulta del usuario sea muy genérica haré preguntas para ir entiendiendo la raíz del problema que requiere solucionar'},
